...
export var ReleaseTreeScope;
(function (ReleaseTreeScope) {
    ReleaseTreeScope["TOP_INSTANCE_ONLY"] = "TOP_INSTANCE_ONLY";
    ReleaseTreeScope["CHILDREN_ONLY"] = "CHILDREN_ONLY";
})(ReleaseTreeScope || (ReleaseTreeScope = {}));
export class Pagination {
    constructor(start = 0, size = 50, returnTotalResults = true) {
        this.start = start;
        this.size = size;
...
export class ResponseConfiguration {
    constructor(returnAlternatives, returnEmbedded, returnPayload, returnPermissions) {
...
export class ExtendedResponseConfiguration extends ResponseConfiguration {
    constructor(incomingLinksPageSize, returnAlternatives, returnEmbedded, returnIncomingLinks, returnPayload, returnPermissions) {
